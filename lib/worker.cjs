...
// node_modules/.pnpm/reg-cli@0.0.0-experimental-wasm13/node_modules/reg-cli/dist/shared/reg-cli.217aa27a.cjs
var require_reg_cli_217aa27a = __commonJS({
  "node_modules/.pnpm/reg-cli@0.0.0-experimental-wasm13/node_modules/reg-cli/dist/shared/reg-cli.217aa27a.cjs"(exports2) {
    "use strict";
    ...
    var readWasm = () => {
      const dir = isCJS ? __dirname : path__default.dirname(url.fileURLToPath(typeof document === "undefined" ? require("url").pathToFileURL(__filename).href : _documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === "SCRIPT" && _documentCurrentScript.src || new URL("shared/reg-cli.217aa27a.cjs", document.baseURI).href));
...
// node_modules/.pnpm/reg-cli@0.0.0-experimental-wasm13/node_modules/reg-cli/dist/worker.cjs
var node_worker_threads = require("node:worker_threads");
var fs = require("node:fs");
var wasmUtil = (init_wasm_util_esm_bundler(), __toCommonJS(wasm_util_esm_bundler_exports));
var node_process = require("node:process");
var utils = require_reg_cli_217aa27a();
require("path");
require("url");
